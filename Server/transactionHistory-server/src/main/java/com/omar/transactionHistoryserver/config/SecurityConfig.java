package com.omar.transactionHistoryserver.config;



import com.omar.transactionHistoryserver.security.jwt.JwtTokenAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers(
                                        ...
                                        "/webjars/**",
                                        "/swagger-ui.html",
                                        "/actuator/prometheus"// Allow access to public endpoints
                                )
                                .permitAll()
