...
import { getOwnerByBookId } from '../fn/book/get-owner-by-book-id';
import { GetOwnerByBookId$Params } from '../fn/book/get-owner-by-book-id';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `getOwnerByBookId()` */
  static readonly GetOwnerByBookIdPath = '/books/{bookId}/owner';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getOwnerByBookId()` instead.
   *
   * This method doesn't expect any request body.
   */
  getOwnerByBookId$Response(params: GetOwnerByBookId$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return getOwnerByBookId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getOwnerByBookId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getOwnerByBookId(params: GetOwnerByBookId$Params, context?: HttpContext): Observable<number> {
    return this.getOwnerByBookId$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
